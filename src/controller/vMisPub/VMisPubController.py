...
class VMisPubController:
    def __init__(self, view, model, padre):
        ...
        self.vPubEliminarView = None
        self.vPubEliminarController = None
    ...
    def eliminar(self, id_cua):
        print("eliminando publicacion")
        # Mostrar ventana para eliminar widget
        #self.vPubEliminarView.mostrar()
        #self.view.hide()
